        ...
        <ClerkProvider
          appearance={{
            ...
            elements: {
              ...
              userButtonPopoverFooter: "!border-t !border-white/8 !bg-[#0B0B0D]",
              ...
              navbar: "!border-r !border-white/8 !bg-[#0B0B0D]",
              navbarButton: "!text-[#A1A1AA] hover:!bg-[#18181B] hover:!text-white",
              navbarButtonText: "!text-inherit",
              navbarButtonIcon: "!text-inherit",
              pageScrollBox: "!bg-[#111113] !text-[#E4E4E7]",
